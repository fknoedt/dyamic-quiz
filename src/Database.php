...
class Database {
	...
	/**
	 * initiated Database (connection) object
	 * @var
	 */
	public static $objDatabase;
	...
	public static function getLastInsertId() {
		...
		$objDatabase = self::getConnection();

		return $objDatabase->dbh->lastInsertId();
