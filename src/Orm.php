...
class Orm
{
	...
	public static function retrieve($value, $column=null, $bObject=true)
	{
		...
		if($bObject) {
			...
			return self::hydrate($aRow, $class);
	...
	/**
	 * returns object for the given class based on $aRow (Database's fetchOne) array
	 * @param $aRow
	 * @param $class
	 * @return mixed
	 * @throws Exception
	 */
	public static function hydrate($aRow, $class) {
